...
/**
 * This is the model class for table "map_user_case".
 *
 * The followings are the available columns in table 'map_user_case':
 * @property integer $id
 ...
 * @property CaseInfo $info
 */
class MapUserCase extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @return MapUserCase the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			...
			'info' => array(self::BELONGS_TO, 'CaseInfo', 'info_id'),
		);
	}
